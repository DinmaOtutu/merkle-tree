...
// Save the file and execute it using the command node (node index.js)
...
If we pass a different value to the `dataToProve` variable and the value doesn't belong to the tree, the output will be false.
